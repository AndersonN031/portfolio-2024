    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          imageUrl: 'leads',
          status: 'Permite adicionar, atualizar, excluir e buscar Leads, com suporte a grupos e campanhas. Grupos e campanhas podem ser criados, atualizados e removidos, e cada Lead pode ser associado a uma ou mais campanhas e grupos. Mais informações no README do projeto no GITHUB',
